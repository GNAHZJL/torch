...
loss_fn=loss_fn.to(device)#loss_fn=loss_fn.cuda()
...
for i in range(epoch):
    ...
    for data in train_dataloader:
        imgs,targets=data
        imgs=imgs.to(device)#imgs=imgs.cuda()
        targets=targets.to(device)#targets=targets.cuda()
